/* ===== VSL MOBILE MENU - EXTERNAL HARD FIX 2026-07-07 =====
   External script intentionally independent from app.js.
   It uses pointerdown/touchstart/click capture so the hamburger works even if
   later modules attach conflicting click handlers. */
(function(){
  "use strict";
  ...
  function bind(){
    ...
    var m = menu();
    if(!b || !m) return;
    if(b.dataset.mobileMenuExternalBound === "1") return;
    b.dataset.mobileMenuExternalBound = "1";
